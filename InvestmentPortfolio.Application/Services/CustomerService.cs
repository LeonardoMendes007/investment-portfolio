...
public class CustomerService : ICustomerService
{
    ...
    public async Task<InvestmentDetails> GetInvestmentByProduct(Guid id, Guid productId)
    {
    ...
    public async Task<IPagedList<InvestmentSummary>> GetInvestmentByQuery(Guid id, int page, int pageSize)
    {
    ...
    public async Task<IPagedList<TransactionDetails>> GetTransactionsByProduct(Guid id, Guid productId, int page, int pageSize)
    {
    ...
    public async Task<IPagedList<TransactionSummary>> GetTransactionByQuery(Guid id, int page, int pageSize)
    {
